...
von Daten mithilfe mathematischer Verfahren zur Entscheidungsfindung.
...
![Abb. 2.c.2: *Microsoft SQL Studio*](topics/Technical%20Applications/mssqlstudio.jpg)
...
In der Alltagssprache werden oft informelle Beispiele für Algorithmen
angeführt, z. B.:
...
![Abb. 3.b.1: Datenstrategie](topics/Data%20Management/data-quadrant-daten-management-methode.jpg)
...
![Abb. 3.c.1: *Ablauf eines Data-Mining-Prozesses*](topics/Data%20Management/Phasen_Data_Mining.png)
...
![Abb. 3.d.1: Data Mining Aufgabetypen](topics/Data%20Management/Gruppen_DataMining.png)
...
Ein Beispiel ist ***Knime.*** Die Datenmanipulation wird visuell
...
![Abb. 3.e.1: Data Mining Tools](topics/Data%20Management/Data%20Mining%20Tools.png)
...
![Abb. 3.e.1: Data Mining Algorithmen in der Häufigkeit der Anwendung](topics/Data%20Management/data_mining_algorithm.jpg)
...
![Abb. 3.g.1: Abwanderungsvorhersage](topics/Data%20Management/Churn_prediction_vorhersage_abwanderung_von_kunden.jpg)
...
-   Anleitung / Installation der Open Source Lösung auf
    den Rechner der Studenten und Konfiguration von *Microsoft Excel (VBA)*
...
Um *R* auf dem *iPad* sinnvoll nutzen zu können, kann die
*Dateien* App in den **Splitscreen** an den Bildschirmrand hinzugefügt werden.

In der Dateien App muss vorher
das **Laufwerk** *ish* **aktiviert** werden. Die Ausgabe-Dateien
liegen unter ish `/home/ish/R/`

Nach der Ausgabe eines
Diagrammes zum **Aktualisieren** des Ordnerinhaltes einmal\
zurück und wieder rein gehen.

![Abb. 4.a.1: *R* auf *iPad* mit *Dateien* App im Splitscreen](topics/Data%20Management/iPad_ish_R.png)
...
Unter *RStudio* lassen sich komplexe Skripte ausführen, das
Paketmanagement ist vereinfacht sowie ist die grafische Ausgabe möglich.

*XQuartz* bietet unter *MacOS* eine X.Org (X Window System) Version. X.Org ist unter Linux /
Unix die grafische Benutzeroberfläche.

![Abb. 4.a.2: *R-Studio*](topics/Rahmenbedingungen/R-Studio.png)
...
1.  1. Datensatz suchen (z.B. auf Datenportalen wie<https://stats.oecd.org/>)
2.  2. Datensatz suchen (z.B. auf Webseiten wie Statista ([https://de.statista.com)](https://de.statista.com/) aufbereiten (Dezimaltrennung, Variablennamen, Spalten bereinigen)
...
![Abb. 6.a.1: Lineare Regressionsgrade](topics/Linear-Regression-model-sample-illustration.png)
...
durch einen booleschen Vektor von Werten repräsentiert werden, die
diesen Variablen zugewiesen werden. Die booleschen Vektoren können von
**Kaufmustern** analysiert werden, die Artikel widerspiegeln, die häufig verbunden oder zusammen
gekauft werden. Solche Muster werden in Form von **Assoziationsregeln** dargestellt.*

![Abb. 7.a.1: Sinnbild](topics/basket-analysis.png)
...
## Methodik: Cluster Analyse K-Means
...
Der **K-Means-Clusteralgorithmus** ist definiert als eine *unüberwachte* **Lernmethode** mit einem iterativen Prozess, bei dem die Datensätze in eine Reihe von *k* Gruppen unterteilt werden, wobei *k* die vom Analysten
...
## Methodik: Neuronale Netze-Analyse
...
plot(datatest$rating, predict_testNN, col='blue', pch=16, ylab = "predicted rating NN", xlab = "real rating") abline(0,1)
```

## Methodiken im Netz

Alle **Methodiken** sind mit Code und Diagrammen [**hier**](https://drbenjamin.github.io/ourdata.html#21_Plots_plots) verfügbar.
